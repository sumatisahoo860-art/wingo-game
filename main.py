...
game_data = {
    ...
    "history": [],
    "admin_choice": None,         # Isme admin string ya number daal sakta hai
    "user_wallets": {"user123": 10000}, 
    "user_bets": {}               
}

# 100% Fixed: Sahi and safe color-number rule format
...
<head>
    ...
    <style>
        ...
        .bet-buttons { display: flex; justify-content: space-around; margin: 15px 0; width: 100%; }
        .btn { padding: 12px 0; font-size: 16px; border: none; border-radius: 25px; color: white; font-weight: bold; cursor: pointer; width: 30%; }
